...
class SettingUtilities:
    DEFAULTLOCALPROJECTPATH = (
        "/home/patrickwsl/anaconda3/envs/LipSyncApp-py391/localwslprojects"
    )
...
if name == "main":
    ...
    settings.generatedynamicfiles()
    settings.updatepath("inputfolderpath", "newinputfolderpath")
    settings.resettodefault("inputfolderpath")
    settings.setpaths(
        inputfolderpath="newinputfolderpath", outputfolderpath="newoutputfolderpath"
    )
    settings.getpath("inputfolder_path")
